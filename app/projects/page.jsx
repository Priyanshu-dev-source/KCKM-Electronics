...
// import { HandPlatter, Cpu, Microchip, Zap, Factory, Blocks } from "lucide-react";
...
//   const serviceAndFeaturesPoints = [
//     {
//       svgs: ["Microchip"],
...
//             exit={{ y: 50, opacity: 0 }}
//             className="h-[100px] w-[350px] md:h-[150px] md:w-[800px] flex items-center justify-center gap-[9px] md:gap-[20px] transition-all"
//           >
//             <HandPlatter className="md:h-[60px] h-[40px] md:w-[60px] w-[40px]" />
//             <h1
...
//             {serviceAndFeaturesPoints.map((points, index) => (
//               <motion.div
//                 key={index}
...
//                 className="h-[250px] md:h-[67%] w-[96%] md:w-[17%] bg-white/10 cursor-pointer hover:scale-[106%] hover:shadow-[0_0_40px_rgba(255,255,255,0.6)] transition-all duration-200 rounded-[20px] flex items-center justify-start px-[30px] pt-[40px] gap-[5px] flex-col"
//               >
//                   {points.svgs.map((iconName, i) => {
//                     const Icon = iconMap[iconName] || HandPlatter;
//                     return (
//                       <Icon key={i} className="h-[55px] w-[55px] text-white" />
//                     );
//                   })}

//                 <p
//                   className={`w-[90%] h-[40px] text-[22px] pt-[28px] text-center ${exo2.className}`}
//                 >
//                   {points.descp}
//                 </p>
//               </motion.div>
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white overflow-x-hidden">
      ...
      <div className="relative top-[60px] md:gap-[50px] flex flex-col items-center px-2 sm:px-6 md:px-0 pt-6 md:pt-12">
        ...
        <div className="relative md:top-[100px] top-[50px] h-[400px] md:h-[350px] w-full border-t-2 border-white/20 flex items-center pt-[0px] justify-start flex-col">
          <Footer />
        </div>
      {/* </div> */}
    </div>
